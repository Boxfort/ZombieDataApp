...
class Ui_ItemTabContents(object):
    def setupUi(self, ItemTabContents):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -34, 722, 1187))
        ...
        self.spinner_spawn_rate = QtWidgets.QSpinBox(self.scrollAreaWidgetContents)
        self.spinner_spawn_rate.setObjectName("spinner_spawn_rate")
        self.verticalLayout_2.addWidget(self.spinner_spawn_rate)
    ...
    def retranslateUi(self, ItemTabContents):
        ...
        self.label_12.setText(_translate("ItemTabContents", "Spawn Rate"))
