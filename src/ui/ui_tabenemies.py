...
class Ui_EnemyTabContents(object):
    def setupUi(self, EnemyTabContents):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, -107, 639, 716))
        ...
        self.spinner_enemy_level = QtWidgets.QSpinBox(self.scrollAreaWidgetContents_3)
        self.spinner_enemy_level.setObjectName("spinner_enemy_level")
        self.verticalLayout_8.addWidget(self.spinner_enemy_level)
        self.label_3 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_3.setObjectName("label_3")
        self.verticalLayout_8.addWidget(self.label_3)
        self.combo_difficulty = QtWidgets.QComboBox(self.scrollAreaWidgetContents_3)
        self.combo_difficulty.setObjectName("combo_difficulty")
        self.combo_difficulty.addItem("")
        self.combo_difficulty.addItem("")
        self.combo_difficulty.addItem("")
        self.combo_difficulty.addItem("")
        self.combo_difficulty.addItem("")
        self.verticalLayout_8.addWidget(self.combo_difficulty)
        ...
        self.verticalLayout_8.addLayout(self.container_tags)
    ...
    def retranslateUi(self, EnemyTabContents):
        ...
        self.label_25.setText(_translate("EnemyTabContents", "Level"))
        self.label_3.setText(_translate("EnemyTabContents", "Difficulty"))
        self.combo_difficulty.setItemText(0, _translate("EnemyTabContents", "EASY"))
        self.combo_difficulty.setItemText(1, _translate("EnemyTabContents", "MEDIUM"))
        self.combo_difficulty.setItemText(2, _translate("EnemyTabContents", "HARD"))
        self.combo_difficulty.setItemText(3, _translate("EnemyTabContents", "VERY HARD"))
        self.combo_difficulty.setItemText(4, _translate("EnemyTabContents", "BOSS"))
