...
class Ui_ZombieData(object):
    def setupUi(self, ZombieData):
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QtCore.QRect(0, 0, 513, 617))
    ...
    def retranslateUi(self, ZombieData):
        ...
        self.label_18.setText(_translate("ZombieData", "Name"))
        self.label_17.setText(_translate("ZombieData", "Sprite Slug"))
        self.label_19.setText(_translate("ZombieData", "Max Health"))
        self.label_20.setText(_translate("ZombieData", "Attack"))
        self.label_21.setText(_translate("ZombieData", "Defence"))
        self.label_22.setText(_translate("ZombieData", "Melee Accuracy"))
        self.label_23.setText(_translate("ZombieData", "Ranged Accuracy"))
        self.label_24.setText(_translate("ZombieData", "Speed"))
        self.label_25.setText(_translate("ZombieData", "Spawn Rate"))
        self.label_26.setText(_translate("ZombieData", "Tags"))
        self.radioButton_9.setText(_translate("ZombieData", "COMMON"))
        self.radioButton_11.setText(_translate("ZombieData", "MILLITARY"))
        self.radioButton_12.setText(_translate("ZombieData", "RadioButton"))
        self.radioButton_10.setText(_translate("ZombieData", "MEDICAL"))
        self.radioButton_13.setText(_translate("ZombieData", "RadioButton"))
        self.radioButton_14.setText(_translate("ZombieData", "RadioButton"))
        self.pushButton_2.setText(_translate("ZombieData", "PushButton"))
        self.pushButton.setText(_translate("ZombieData", "PushButton"))
